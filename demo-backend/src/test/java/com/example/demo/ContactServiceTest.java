...
//
//		Contact contactOne = new Contact(1, "One", "Surname1One");
//		Contact contactTwo = new Contact(2, "Two", "Surname1Two");
//		Contact contactThree = new Contact(3, "Three", "Surname1Three");
//
//		list.add(contactOne);
//		list.add(contactTwo);
...
//				Optional.of(new Contact(1, "One", "Surname1One")));
//
...
//	@Test
//	void addContactTest() {
//		Contact createContactRequest = new Contact("One", "Surname1One");
...
//		Contact editContactRequest = new Contact(1, "OneEdit", "Surname1OneEdit");
